...
- `pages/`：包含所有页面，分为普通页面（如 `home`、`profile`）和管理员专属页面（`admin/resumeManage`、`admin/resumeEdit`）。
- `services/`：封装业务逻辑的服务层，如 `resume.js` 提供简历相关的 API 调用。
...
- **消息**：路径为 `pages/message/index`，图标为对话框形状。
- **我的**：路径为 `pages/profile/index`，图标为用户头像形状。
...
**Diagram sources**  
- [app.json](file://miniprogram/app.json#L30-L49)
- [custom-tab-bar/index.js](file://miniprogram/custom-tab-bar/index.js#L13-L48)
...
**Section sources**  
- [home/index.js](file://miniprogram/pages/home/index.js#L11-L25)
...
**Section sources**  
- [resumeList/index.js](file://miniprogram/pages/resumeList/index.js#L197-L576)
...
**Section sources**  
- [resumeDetail/index.js](file://miniprogram/pages/resumeDetail/index.js#L166-L708)
- [resumeDetail/index.json](file://miniprogram/pages/resumeDetail/index.json)

### 个人中心页

个人中心页展示用户个人信息，并提供进入简历管理页的入口。页面在 `onShow` 时调用 `getOrCreateMe` 获取用户数据，并根据用户角色判断是否显示管理入口。
...
**Section sources**  
- [profile/index.js](file://miniprogram/pages/profile/index.js#L1-L53)
...
**Section sources**  
- [resumeManage/index.js](file://miniprogram/pages/admin/resumeManage/index.js#L23-L112)
...
**Section sources**  
- [resumeEdit/index.js](file://miniprogram/pages/admin/resumeEdit/index.js#L8-L211)
...
**Diagram sources**  
- [home/index.js](file://miniprogram/pages/home/index.js#L16-L24)
- [resumeList/index.js](file://miniprogram/pages/resumeList/index.js#L578-L583)
- [profile/index.js](file://miniprogram/pages/profile/index.js#L50)
- [resumeManage/index.js](file://miniprogram/pages/admin/resumeManage/index.js#L74-L80)
...
**Section sources**  
- [resumeList/index.js](file://miniprogram/pages/resumeList/index.js#L330-L576)
...
**Section sources**  
- [resumeEdit/index.js](file://miniprogram/pages/admin/resumeEdit/index.js#L106-L113)
...
- **交互反馈**：使用 `wx.showToast` 提供操作反馈，如“已保存”、“删除失败”等。

## 总结

安得褓贝小程序的前端页面结构清晰，功能完整。通过自定义 TabBar 提供直观的导航，各页面职责明确，数据加载和状态管理合理。管理员功能通过角色校验确保安全性，文件上传和视频播放优化了用户体验。整体设计符合小程序开发规范，具备良好的可维护性和扩展性。