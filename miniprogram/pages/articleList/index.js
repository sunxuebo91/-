...
const CANONICAL_TAG_DEFS = [
  // 亲子早教放最前，避免"科学育儿""自律"被宽泛词抢走
  { tag: '亲子早教', patterns: [/早教|启蒙|绘本|感统|专注力|语言发育|大运动|精细动作|好习惯|自律|反宠|科学育儿|育儿理念|育儿方法|性格培养|情绪管理|大脑发育|认知发展/] },
  ...
  { tag: '产后恢复', patterns: [/产后|月子|坐月子|产褥|哺乳|母乳|催乳|月子餐|产后修复|产后抑郁|开奶|追奶|堵奶|盆底肌|腹直肌|恶露/] },
  { tag: '新生儿养护', patterns: [/新生儿|0-3个月|0-3 月|满月|百天|脐带护理|拍嗝|黄疸|肠胀气|红屁屁|新生儿喂养|混合喂养|奶粉喂养/] },
  // 婴幼护理：只用明确的照护/疾病词，不再用"宝宝""婴儿""生长发育"等宽泛词
  { tag: '婴幼护理', patterns: [/婴幼儿|4个月|4-6个月|6-12个月|添加辅食|断奶|米粉|果泥|如厕训练|口腔护理|湿疹|积食|腹泻|生长曲线|身高体重|体重不达标/] }
];
...
function normalizeRawTag(raw) {
  ...
  // 归一化常见同义（去掉"育儿"→"婴幼护理"这类宽泛映射）
  s = s
    .replace(/孕中|孕期中|孕早期|孕中期|孕晚期/g, '孕期呵护')
    .replace(/产后恢复|产后修复|月子护理|坐月子/g, '产后恢复')
    .replace(/科学育儿|育儿理念|育儿方法/g, '亲子早教')
